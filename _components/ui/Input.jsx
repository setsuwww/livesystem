...
function Input({ className, type, typeSearch = false, ...props }) {
  ...
  const searchFocus = "border-slate-100 focus-visible:border-slate-300/50 bg-slate-50 focus-visible:ring-slate-100 placeholder:text-slate-400 caret-slate-400"
