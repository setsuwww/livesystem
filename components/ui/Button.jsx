...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-all disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus:ring-2",
  {
    variants: {
      variant: {
        default: "bg-gradient-to-b from-zinc-800 to-zinc-600 inset-shadow-xs inset-shadow-zinc-500 text-white shadow-xs hover:from-zinc-900 hover:to-zinc-700 hover:inset-shadow-zinc-600 focus:ring-zinc-400",
