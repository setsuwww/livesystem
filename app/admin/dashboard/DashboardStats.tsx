    ...
    <div className="p-5 rounded-2xl border border-gray-200 shadow-sm bg-white flex items-center gap-4 hover:border-gray-300 transition-colors">
      ...
      <div className="flex flex-col flex-1">
        ...
        <div className="flex items-center space-x-2">
          ...
          {/* Icon switch */}
          <button onClick={toggleValue} className={`${showNegative ? "hover:bg-red-100" : "hover:bg-green-100"} p-1 rounded-full bg-gray-100 text-gray-500 transition-colors`} title={showNegative ? "Show Positive" : "Show Negative"}>
