...
export function DivisionsStatusBadge({ status, onToggle }) {
  ...
  return (
    <Badge variant="outline" onClick={onToggle} className="flex items-center gap-2 px-2.5 py-1 rounded-full cursor-pointer select-none border-slate-200 hover:bg-slate-50 transition">
